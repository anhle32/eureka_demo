...
with st.container():
   st.markdown("**<span style='color:green;'>Đề tài “Ứng dụng phương pháp SEM-NEURAL NETWORK để xây dựng mô hình dự báo trải nghiệm khách hàng về dịch vụ ngân hàng số tại các Ngân hàng thương mại Việt Nam” - TS. LÊ HOÀNG ANH & TS. PHẠM THỊ HÀ AN </span>**", unsafe_allow_html=True)
